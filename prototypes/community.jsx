    ...
    <div className="sp">
      <div className="sp-bar">
        <div className="sp-input-wrap">
          ...
          />
          {filters.search && (
            <button className="sp-clear-x" onClick={() => { onFilterChange('search', ''); onSearch() }}>&times;</button>
          )}
        </div>
        <button onClick={() => setExpanded(e => !e)} className="btn btn-secondary btn-sm sp-filter-btn">
          &#9776; Filters
          {hasFilters && <span className="sp-dot" />}
        </button>
      ...
      {expanded && (
        <div className="sp-expanded">
          <div>
            ...
            <input className="sp-field" type="text" placeholder="e.g. Tokyo, Paris..." value={filters.location} onChange={e => onFilterChange('location', e.target.value)} />
          </div>
          <div>
            <label className="sp-label">Creator</label>
            <input className="sp-field" type="text" placeholder="Username or name..." value={filters.creator} onChange={e => onFilterChange('creator', e.target.value)} />
          </div>
          <div>
            <label className="sp-label">From</label>
            <input className="sp-field sp-date" type="date" value={filters.dateFrom} onChange={e => onFilterChange('dateFrom', e.target.value)} />
          </div>
          <div>
            <label className="sp-label">To</label>
            <input className="sp-field sp-date" type="date" value={filters.dateTo} onChange={e => onFilterChange('dateTo', e.target.value)} />
          </div>
      ...
      {hasFilters && !expanded && (
        <div className="sp-status">
          ...
          <button className="sp-clear-link" onClick={onClear}>Clear filters</button>
        </div>
      )}
    </div>
  )
