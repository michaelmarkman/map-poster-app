...
// (Lens / DoF / Time / Clouds) plus the Capture CTA at the far right.
// Moved here from TR (scrub) and BM (Capture) respectively. All atom
// state stays untouched — just relocated render.
//
