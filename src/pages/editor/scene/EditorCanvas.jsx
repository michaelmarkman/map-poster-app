...
// is the biggest perf lever for thermal-constrained devices. The
// visible blur from CSS upscaling is comparable to (and softer than)
// the artifacts we'd see from running the full pipeline at 3× and
// hitting the GPU watchdog.
