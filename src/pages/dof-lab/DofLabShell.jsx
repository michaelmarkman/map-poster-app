...
// DoF Lab — a copy of the pill editor used to prototype DoF experiments.
// Mounts at /dof-lab. Reuses all `mock-*` CSS by mounting
// `body.mock-mounted`, adds `body.dof-lab-mounted` as an extra hook for
// lab-only overrides. The lab is short-lived scaffolding — delete the
// `src/pages/dof-lab/` directory once a winning DoF variant is merged
// back into /app. See docs/superpowers/specs/2026-04-21-dof-lab-design.md
export default function DofLabShell() {
  useEffect(() => {
    document.body.classList.add('editor-mounted', 'mock-mounted', 'dof-lab-mounted')
    return () =>
      document.body.classList.remove('editor-mounted', 'mock-mounted', 'dof-lab-mounted')
  }, [])
